<div class="container py-5 bg-light rounded shadow-sm" style="max-width: 900px;">
    <h2 class="mb-4 text-center text-primary fw-bold">Criar Novo Pedido</h2>
    ...
    <form wire:submit.prevent="salvar" class="needs-validation" novalidate>
        ...
        <div class="mb-4 d-flex justify-content-between align-items-center border-top pt-3">
            <div>
                ...
                <p class="fs-5 text-success fw-bold mb-0">R$ {{ number_format($valor_total, 2, ',', '.') }}</p>
            </div>
            <div>
                <label class="form-label fw-semibold mb-1">Valor com Desconto:</label>
                <p class="fs-5 text-danger fw-bold mb-0">R$ {{ number_format($valor_desconto, 2, ',', '.') }}</p>
            </div>
        </div>

        <div class="d-flex justify-content-center gap-3">
            <button type="submit" class="btn btn-lg btn-primary rounded-pill px-4 shadow-sm">Salvar Pedido</button>
